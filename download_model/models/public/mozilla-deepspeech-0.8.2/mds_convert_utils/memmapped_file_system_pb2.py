...
# source: memmapped_file_system.proto from Tensorflow 1.15.3, https://github.com/tensorflow/tensorflow/blob/v1.15.3/tensorflow/core/util/memmapped_file_system.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='memmapped_file_system.proto',
  package='tensorflow',
  syntax='proto3',
...
MemmappedFileSystemDirectoryElement = _reflection.GeneratedProtocolMessageType('MemmappedFileSystemDirectoryElement', (_message.Message,), dict(
  ...
  __module__ = 'memmapped_file_system_pb2'
